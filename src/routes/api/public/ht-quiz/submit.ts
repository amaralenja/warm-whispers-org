        ...
        try {
          ...
          const { data: saved, error: saveErr } = await supabasePublic
            .rpc("submit_ht_quiz_submission" as any, {
              ...
              _utm_source: pickStr(b.utm_source ?? b.utmSource),
              _utm_medium: pickStr(b.utm_medium ?? b.utmMedium),
              _utm_campaign: pickStr(b.utm_campaign ?? b.utmCampaign),
              _utm_content: pickStr(b.utm_content ?? b.utmContent),
              _fbc: pickStr(b.fbc),
              _fbp: pickStr(b.fbp),
              _fbclid: pickStr(b.fbclid ?? b.fbClid),
              _gclid: pickStr(b.gclid ?? b.gClid),
