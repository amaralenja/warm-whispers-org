...
import { TrendingUp, ShoppingBag, Receipt, Wallet, AlertTriangle, Coins, ArrowUpRight } from "lucide-react";
  ...
  return (
    <main className="min-h-[calc(100vh-3.5rem)] bg-background">
      <div className="mx-auto max-w-7xl px-8 py-10">
        ...
        {/* KPIs — 4 métricas grandes */}
        <section className="mt-8 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-border bg-border lg:grid-cols-4">
          <Kpi
        ...
        {/* Tabela de experts */}
        <section className="mt-6 overflow-hidden rounded-2xl border border-border bg-card/40">
