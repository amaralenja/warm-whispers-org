          ...
          <div className="mt-4 h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data.serieDaily}>
                ...
                />
                <Area type="monotone" dataKey="total" stroke="#10b981" fill="url(#gradFat)" strokeWidth={2} />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </section>
                ...
                <PieChart>
                  <Pie data={data.topVendedores.slice(0, 6)} dataKey="total" nameKey="utm" cx="50%" cy="50%" outerRadius={80} innerRadius={40} paddingAngle={2}>
                    {data.topVendedores.slice(0, 6).map((_, i) => (
                      <Cell key={i} fill={["#10b981", "#3b82f6", "#06b6d4", "#a855f7", "#ec4899", "#f97316"][i % 6]} />
                    ))}
                  </Pie>
            ...
            <div className="flex-1 space-y-2">
              {data.topVendedores.slice(0, 6).map((v, i) => (
                <div key={v.utm} className="flex items-center gap-3">
                  <span className="h-2.5 w-2.5 rounded-full" style={{ background: ["#10b981", "#3b82f6", "#06b6d4", "#a855f7", "#ec4899", "#f97316"][i % 6] }} />
